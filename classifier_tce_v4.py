...
subject_id=[1,4,10,11,12,13,14,15,16,17,20,21,22,24,25,26,27,28,31,32,33,34,35,36,38,40,41,42,43,44,46,47,48,49,50]
...
feature_set_train=feature_set.loc[feature_set['ID'].isin(subject_id)]
...
# E4
model_1=RandomForestClassifier(n_estimators=100,criterion='gini',max_depth=30, random_state=3)
...
train_X, valid_X, train_y, valid_y = train_test_split(X_train_new, label_2_train, test_size=0.3, random_state=3)
...
# fit_2=model_2.fit(train_X,train_y)
# fit_3=model_3.fit(train_X,train_y)
# fit_4=model_4.fit(train_X,train_y)
...
print(roc_auc_score(valid_y, predicted_1))
# print(roc_auc_score(valid_y, predicted_2))
# print(roc_auc_score(valid_y, predicted_3))
# print(roc_auc_score(valid_y, predicted_4))
#accuracy_feature=accuracy_score(label_2_test,predicted_1)
#print(accuracy_feature)
metric=sklearn.metrics.classification_report(valid_y,predicted_1)
print(metric)
